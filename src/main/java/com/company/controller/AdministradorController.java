...
public class AdministradorController implements Initializable {
    ...
    @FXML
    private TableView<Sale> tbSalesAdmin;
    @FXML
    ...
    @FXML
    private TableColumn<Sale, Long> colIdSale;
    @FXML
    private TableColumn<Sale, Integer> colIdEmployee;
    @FXML
    private TableColumn<Sale, Integer> colIdBranchOffice;
    @FXML
    private TableColumn<Sale, Double> colIdTotalSale;
    @FXML
    private TableColumn<Sale, String> coldescription;
    @FXML
